...
$SITE['organ']			= 'My organization name';
...
$SITE['latitude']		= '47.31';    //North=positive, South=negative decimal degrees
$SITE['longitude']		= '-122.36';  //East=positive, West=negative decimal degrees
...
###$SITE['fcsturlNWS']		= 'http://forecast.weather.gov/MapClick.php?CityName=Tacoma&state=WA&site=MTR&textField1=47.31&textField2=-122.36&e=1&TextType=2';
$SITE['fcsturlNWS']		= 'https://forecast.weather.gov/MapClick.php?site=WA558&lat=47.3084&lon=-122.3632';
...
// use "Zone|Location|Point-printableURL",  as entries .. first one will be the default forecast.
  "WA558|Seattle|http://forecast.weather.gov/MapClick.php?CityName=Seattle&state=WA&site=MTR&textField1=47.31&textField2=-122.36&e=1&TextType=2",
);
...
// NOAA warning zone
$SITE['noaazone'] 		= 'WAZ558'; // used for NOAA advisories and advforecast2.php zone forecasts
...
$SITE['NWSregion'] = 'nw'; // NOAA/NWS regional radar maps
// 'ak' = Alaska,
...
$SITE['WUsatellite'] = 'nw'; // Wunderground regional satellite maps
...
$SITE['GR3radar']	= 'katx';	// set to lower-case full name of NEXRAD radar site
